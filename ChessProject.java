...
public class ChessProject extends JFrame implements MouseListener, MouseMotionListener {
	...
	*/
	...
	public void mouseReleased(MouseEvent e) {
		...
		/*
		The only piece that has been enabled to move is a White Pawn...but we should really have this as a separate
		method somewhere...how would this work.
		
		So a Pawn is able to move two squares forward on its first go but only one square after that. 
		...
		*/
			...
			if(startY == 6){	//Black pawn makes its first move from here.
				if((yMovement==1||yMovement==2)&&(startY > landingY)&&(xMovement==0)){
					if(yMovement == 2){
						...
						//if((piecePresent(e.getX(), (e.getY())))&&((((landingX==(startX+1)&&(startX+1<=7)&&(landingY==(startY+1)&&(startY+1<=7)))))||(((landingX==(startX-1)&&(startX-1>=0)&&(landingY==(startY+1)&&(startY+1>=0)))))))	//Added and made use of the the landingY variable	//||(landingY==(startY+1)&&(startY+1>=0))))
		...
		//Potentially redo white pawn to use variables like black pawn instead of the raw maths
			...
			if(((landingX < 0) || (landingX > 7))||((landingY < 0)||(landingY > 7))){
				...
				((landingX == startX+1) && (landingY == startY-2))||
				((landingX == startX+2) && (landingY == startY-1))||
				((landingX == startX-2) && (landingY == startY-1)))&& (landingY >= 0 && landingY <= 7)&&(landingX >= 0 && landingX <= 7)){
			...
			if(((landingX < 0)||(landingX >7))||((landingY<0)||(landingY>7))){
				...
				// else if((yMovement == 1)&&(startY > landingY)&&(xMovement == 1)){
					...
					if(!validMove){		
						...
						private String getPieceName(int xCor, int yCor){
							Component c =  chessBoard.findComponentAt(xCor, yCor);
							String pieceName = c.toString();
							...
							*/
							...
							private void makeAIMove(){
								...
								*/
								...
								Stack temporary = (Stack)completeMoves.clone();	//Added stack here.
